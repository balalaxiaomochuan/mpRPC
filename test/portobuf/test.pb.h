...
// uint32 useid = 1;
inline void GetFriendListRequest::clear_useid() {
  useid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListRequest::_internal_useid() const {
  return useid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListRequest::useid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRequest.useid)
  return _internal_useid();
}
inline void GetFriendListRequest::_internal_set_useid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  useid_ = value;
}
inline void GetFriendListRequest::set_useid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_useid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListRequest.useid)
}
